...
I added a Python script in `scripts/` called `new_post.py` that creates a default template for a new post. One this I still need to figure out how to do is how to render posts locally without pushing the rendered content to GitHub. 